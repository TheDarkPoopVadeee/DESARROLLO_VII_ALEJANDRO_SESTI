...
$misComidas = ["Pasta", "Pizza", "Tacos"]; // Reemplaza con tus comidas favoritas
$comidasAmigo = ["Remolacha", "Coliflor", "Banana"]; // Reemplaza con las comidas favoritas de tu amigo
