...
$misAmigos = ["Alejandro","Daniel","Marcos"]; // Reemplaza esto con tu array de amigos
array_push($misAmigos, "Alisson", "Ingrid"); // Reemplaza las comillas vacías con los nombres de tus amigos
