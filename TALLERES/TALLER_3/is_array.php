...
$miArray = [0,1,2,3,4,5]; // Reemplaza esto con tu propio array
$miString = "Que Tenga Un Maravilloso Dia"; // Reemplaza esto con tu propio string
$miNumero = 8; // Reemplaza esto con tu propio número
