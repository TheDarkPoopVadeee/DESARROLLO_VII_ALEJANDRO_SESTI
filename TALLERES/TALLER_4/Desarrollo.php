...
class Desarrollador extends Empleado implements Evaluable {
    ...
    public function evaluarDesempenio() {
        return "Evaluación de desempeño del desarrollador: Muy bueno.";
    }

    public function __toString() {
        return parent::__toString() . ", Lenguaje Principal: $this->lenguajePrincipal, Nivel de Experiencia: $this->nivelExperiencia";
    }
}